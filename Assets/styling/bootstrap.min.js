...
!(function(t, e) {
  ...
  function r(t, e) {
    ...
    (t.prototype = Object.create(e.prototype)), (t.prototype.constructor = t),
        (n = t), (i = e),
        (Object.setPrototypeOf || function(t,
    ...
    if ("string" == typeof e && t) {
      ...
      if (h)
        ...
        var d = P(a, e.replace(C, "")),
            f = r ? (function(t, e, n) {
              return function i(o) {
                for (var s = t.querySelectorAll(e), r = o.target;
                     r && r !== this; r = r.parentNode)
  ...
  var K = {
    ...
    off : function(t, e, n, i) {
      if ("string" == typeof e && t) {
        var o = B(e, n, i), s = o[0], r = o[1], a = o[2], l = a !== e, c = x(t),
            u = e.startsWith(".");
        if (void 0 === r) {
    ...
    trigger : function(t, e, n) {
      ...
      W = (function() {
        ...
        return ((t.prototype.dispose =
                     function() {
                       var t, e;
                       (t = this._element), (e = this.constructor.DATA_KEY),
                           A.delete(t, e), (this._element = null);
                     }),
                ...
                o(t, null,
                  [
                    {
                      key : "VERSION",
                      get : function() { return "5.0.0-beta2"; },
                    },
                  ]),
                t);
      })(),
  ...
  var X = {
    ...
    removeDataAttribute : function(t,
                                   e) { t.removeAttribute("data-bs-" + Y(e)); },
      ...
      J = (function(t) {
        function e(e, n) {
          ...
          return (
              ...
              (i._interval = null), (i._activeElement = null),
              (i._isPaused = !1), (i._isSliding = !1), (i.touchTimeout = null),
              (i.touchStartX = 0), (i.touchDeltaX = 0),
              (i._config = i._getConfig(n)),
              (i._indicatorsElement = Q(".carousel-indicators", i._element)),
              (i._touchSupported = "ontouchstart" in document.documentElement ||
                   ...
                   if (s && s.classList.contains("active"))
                     ...
                     if (((this._isSliding = !0), a && this.pause(),
                       ...
                       K.one(i, "transitionend", function() {
                         s.classList.remove(l, c), s.classList.add("active"),
  ...
  K.on(document, "click.bs.carousel.data-api",
      ...
      K.on(window, "load.bs.carousel.data-api", function() {
        for (var t = q('[data-bs-ride="carousel"]'), e = 0, n = t.length; e < n;
             e++)
        ...
        return (
            ...
            (n.dispose =
                 function() {
                   t.prototype.dispose.call(this), (this._config = null),
                       (this._parent = null), (this._triggerArray = null),
            ...
            (n._getParent =
                 function() {
                   ...
                   return (g(e) ? (void 0 === e.jquery && void 0 === e[0]) ||
                                      (e = e[0])
                                : (e = Q(e)),
                     ...
                     if (!K.trigger(this._element, "show.bs.dropdown", o)
                       ...
                       if (this._inNavbar)
                         ...
                         (this._popper = t.createPopper(s, this._menu, r)),
                             a && X.setDataAttribute(this._menu, "popper",
                                                     "static");
                       }
                       var l;
  ...
  K.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]',
      ...
      gt = (function(t) {
        function e(e, n) {
          ...
          return (((i = t.call(this, e) || this)._config = i._getConfig(n)),
                  (i._dialog = Q(".modal-dialog", e)), (i._backdrop = null),
                  (i._isShown = !1), (i._isBodyOverflowing = !1),
                  (i._ignoreBackdropClick = !1), (i._isTransitioning = !1),
       ...
       function(t) {
         ...
         ("A" !== this.tagName && "AREA" !== this.tagName) ||
             ...
             K.one(n, "show.bs.modal", function(t) {
               t.defaultPrevented || K.one(n, "hidden.bs.modal",
      ...
      Lt = (function(e) {
        function i(t, i) {
          ...
          return (((o = e.call(this, t) || this)._isEnabled = !0),
                  ...
                  (o._activeTrigger = {}), (o._popper = null),
                  (o.config = o._getConfig(i)), (o.tip = null),
                  o._setListeners(), o);
        }
        r(i, e);
        var a = i.prototype;
        return (
            (a.enable = function() { this._isEnabled = !0; }),
            ...
            (a.dispose =
                 function() {
                   clearTimeout(this._timeout),
                       ...
                       this._popper && this._popper.destroy(),
                       (this._popper = null), (this.config = null),
                       (this.tip = null), e.prototype.dispose.call(this);
                 }),
            (a.show =
                 function() {
                   var e = this;
            ...
            (a.isWithContent = function() { return Boolean(this.getTitle()); }),
            (a.getTipElement =
                 function() {
                   if (this.tip)
                     return this.tip;
                 ...
                 function(t) {
                   ...
                   return (
                       Object.keys(e).forEach(function(
                           t) { wt.has(t) && delete e[t]; }),
                       t && "object" == typeof t.container &&
                           t.container.jquery && (t.container = t.container[0]),
                       "number" ==
                               typeof (
                       ...
                       t.sanitize && (t.template = bt(t.template, t.allowList,
                                                      t.sanitizeFn)),
                       t);
                 }),
  ...
  K.on(window, "load.bs.scrollspy.data-api", function() {
    q('[data-bs-spy="scroll"]')
        .forEach(function(t) { return new Pt(t, X.getDataAttributes(t)); });
  }), T("scrollspy", Pt);
  var xt = (function(t) {
    function e() { return t.apply(this, arguments) || this; }
    r(e, t);
      ...
      Mt = (function(t) {
        ...
        return (
            (n.show =
                 function() {
                   var t = this;
                   if (!K.trigger(this._element, "show.bs.toast")
                            .defaultPrevented) {
                     this._clearTimeout(),
