...
!(function(a, b) {
  ...
  (n.fn = n.prototype = {
    ...
    splice : c.splice,
      ...
      n.extend({
        ...
        isNumeric : function(
            a) { return !n.isArray(a) && a - parseFloat(a) + 1 >= 0; },
        ...
        inArray : function(a, b,
                           c) { return null == b ? -1 : g.call(b, a, c); },
        merge : function(a, b) {
  ...
  var t = (function(a) {
    ...
    function gb(a, b, d, e) {
      ...
      if (((b ? b.ownerDocument || b : v) !== n && m(b), (b = b || n),
           (d = d || []), (k = b.nodeType),
        ...
        (gb.matchesSelector =
             function(a, b) {
               if (((a.ownerDocument || a) !== n && m(a),
                    (b = b.replace(U, "='$1']")),
                    !(!c.matchesSelector || !p || (r && r.test(b)) ||
                      (q && q.test(b)))))
                 try {
                   var d = s.call(a, b);
    ...
    function xb(a) {
      for (var b, c, e,
           ...
           i = g ? 1 : 0, k = sb(function(a) { return a === b; }, h, !0),
    ...
    sibling : function(a, b) {
      ...
      n.fn.extend({
        ...
        closest : function(a, b) {
          for (var c,
               d = 0, e = this.length, f = [],
               g = u.test(a) || "string" != typeof a ? n(a, b || this.context)
                                                     : 0;
               e > d; d++)
        ...
        index : function(a) {
          return a ? "string" == typeof a ? g.call(n(a), this[0])
  ...
  n.each({
    ...
    siblings : function(
        a) { return n.sibling((a.parentNode || {}).firstChild, a); },
  ...
  (n.Callbacks = function(a) {
    ...
    var b, c, d, e, f, g, h = [], i = !a.once && [], j = function(l) {
      ...
      has : function(
          a) { return a ? n.inArray(a, h) > -1 : !(!h || !h.length); },
  ...
  (K.uid = 1), (K.accepts = n.acceptData), (K.prototype = {
    ...
    hasData : function(
        a) { return !n.isEmptyObject(this.cache[a[this.expando]] || {}); },
    discard : function(
        a) { a[this.expando] && delete this.cache[a[this.expando]]; },
  });
  ...
  n.extend({
    ...
    _removeData : function(a, b) { L.remove(a, b); },
      ...
      n.fn.extend({
        ...
        removeData : function(
            a) { return this.each(function() { M.remove(this, a); }); },
      }),
      n.extend({
  ...
  (n.event = {
    ...
    trigger : function(b, c, d, e) {
      var f, g, h, i, k, m, o,
          p = [ d || l ], q = j.call(b, "type") ? b.type : b,
        ...
        return ((b.type = q),
                e || b.isDefaultPrevented() ||
                    ...
                    (k && n.isFunction(d[q]) && !n.isWindow(d) &&
                     ((h = d[k]), h && (d[k] = null), (n.event.triggered = q),
                      d[q](), (n.event.triggered = void 0), h && (d[k] = h))),
                b.result);
      }
    },
    dispatch : function(a) {
      ...
      filter : function(a, b) {
        ...
        return (
            null == a.pageX && null != b.clientX &&
                ((c = a.target.ownerDocument || l), (d = c.documentElement),
                 (e = c.body),
                 (a.pageX = b.clientX +
    ...
    simulate : function(a, b, c, d) {
      ...
      k.focusinBubbles ||
          n.each(
              ...
              function(a, b) {
                var c = function(
                    a) { n.event.simulate(b, a.target, n.event.fix(a), !0); };
                n.event.special[b] = {
                  setup : function() {
        ...
        on : function(a, b, c, d, e) {
          ...
          return (
              1 === e &&
                  ((f = d),
                   (d = function(
                        a) { return n().off(a), f.apply(this, arguments); }),
                   (d.guid = f.guid || (f.guid = n.guid++))),
              this.each(function() { n.event.add(this, a, d, c, b); }));
        },
  ...
  n.extend({
    clone : function(a, b, c) {
      ...
      return ((g = ob(h, "script")),
              g.length > 0 && mb(g, !i && ob(a, "script")), h);
    },
    ...
    cleanData : function(a) {
      ...
      n.fn.extend({
        ...
        replaceWith : function() {
          ...
          return (this.domManip(arguments, function(b) {
            (a = this.parentNode), n.cleanData(ob(this)),
      ...
      n.each({
        ...
        replaceAll : "replaceWith",
             ...
             function(a, b) {
               n.fn[a] = function(a) {
                 for (var c, d = [], e = n(a), g = e.length - 1, h = 0; g >= h;
                      h++)
                   (c = h === g ? this : this.clone(!0)), n(e[h])[b](c),
                       f.apply(d, c.get());
        ...
        c || ((c = sb(a, b)),
              ("none" !== c && c) ||
                  ((qb = (qb ||
                   ...
                   (b = qb[0].contentDocument), b.write(), b.close(),
                   (c = sb(a, b)), qb.detach()),
              (rb[a] = c)),
        c);
  }
  ...
  function xb(a, b, c) {
    ...
    return (
        (c = c || wb(a)), c && (g = c.getPropertyValue(b) || c[b]),
      ...
      a.getComputedStyle && n.extend(k, {
        ...
        reliableMarginRight : function() {
          ...
          return (
              ...
              (f.style.width = "1px"), d.appendChild(e),
               ...
               n.cssHooks[b] = {
                 ...
                 set : function(a, c, d) {
                   ...
                   return Gb(
                       a, c,
                       d ? Hb(a, b, d,
                              "border-box" === n.css(a, "boxSizing", !1, e), e)
                         : 0);
                 },
               };
             }),
      (n.cssHooks.marginRight =
           yb(k.reliableMarginRight,
              function(a, b) {
    ...
    run : function(a) {
      ...
      return ((this.pos = b =
                   this.options.duration
                       ? n.easing[this.easing](a, this.options.duration * a, 0,
      ...
      (Kb.prototype.init.prototype = Kb.prototype), (Kb.propHooks = {
        _default : {
          ...
          set : function(a) {
            n.fx.step[a.prop]
                ? n.fx.step[a.prop](a)
                : a.elem.style && (null != a.elem.style[n.cssProps[a.prop]] ||
                                   n.cssHooks[a.prop])
  ...
  (n.Animation = n.extend(Xb, {
    ...
    prefilter : function(a, b) { b ? Qb.unshift(a) : Qb.push(a); },
      ...
      (n.fx.interval = 13),
      (n.fx.start =
           function() { Mb || (Mb = setInterval(n.fx.tick, n.fx.interval)); }),
      (n.fx.stop = function() { clearInterval(Mb), (Mb = null); }),
      ...
      (n.fn.delay = function(a, b) {
        ...
        (a.type = "checkbox"), (k.checkOn = "" !== a.value),
            (k.optSelected = c.selected), (b.disabled = !0),
            (k.optDisabled = !c.disabled), (a = l.createElement("input")),
            (a.value = "t"), (a.type = "radio"),
            (k.radioValue = "t" === a.value);
      })();
  var Yb, Zb, $b = n.expr.attrHandle;
  n.fn.extend({
    attr : function(a,
                    b) { return J(this, n.attr, a, b, arguments.length > 1); },
    removeAttr : function(
  ...
  n.fn.extend({
    prop : function(a,
                    b) { return J(this, n.prop, a, b, arguments.length > 1); },
  ...
  n.fn.extend({
    addClass : function(a) {
      ...
      if (n.isFunction(a))
        return this.each(function(
            b) { n(this).addClass(a.call(this, b, this.className)); });
      if (h)
    ...
    removeClass : function(a) {
      ...
      if (n.isFunction(a))
        return this.each(function(
            b) { n(this).removeClass(a.call(this, b, this.className)); });
      if (h)
        for (b = (a || "").match(E) || []; j > i; i++)
          if (((c = this[i]),
               (d = 1 === c.nodeType &&
  ...
  n.extend({
    ...
    ajaxSetup : function(
        a,
        b) { return b ? sc(sc(a, n.ajaxSettings), b) : sc(n.ajaxSettings, a); },
    ajaxPrefilter : qc(lc),
    ajaxTransport : qc(mc),
    ajax : function(a, b) {
      "object" == typeof a && ((b = a), (a = void 0)), (b = b || {});
      var c, d, e, f, g, h, i, j,
          k = n.ajaxSetup({}, b), l = k.context || k,
      ...
      if (((o.promise(v).complete = p.add), (v.success = v.done),
           ...
           (k.dataTypes =
                n.trim(k.dataType || "*").toLowerCase().match(E) || [ "" ]),
           null == k.crossDomain &&
      ...
      (i = n.event && k.global),
          ...
          (k.type = k.type.toUpperCase()), (k.hasContent = !ic.test(k.type)),
          (d = k.url),
          k.hasContent ||
              (k.data && ((d = k.url += (dc.test(d) ? "&" : "?") + k.data),
                          delete k.data),
               k.cache === !1 &&
                   (k.url = fc.test(d)
                                ? d.replace(fc, "$1_=" + cc++)
      ...
      function x(a, b, f, h) {
        ...
        2 !== t &&
            ((t = 2), g && clearTimeout(g), (c = void 0), (e = h || ""),
             ...
             (j = (a >= 200 && 300 > a) || 304 === a), f && (u = tc(k, v, f)),
             (u = uc(k, u, v, j)),
             j ? (k.ifModified &&
    ...
    getScript : function(a, b) { return n.get(a, void 0, b, "script"); },
      ...
      (n.expr.filters.hidden = function(
           a) { return a.offsetWidth <= 0 && a.offsetHeight <= 0; }),
      (n.expr.filters.visible = function(
           a) { return !n.expr.filters.hidden(a); });
  var vc = /%20/g, wc = /\[\]$/, xc = /\r?\n/g,
                     ...
                     b && (delete Cc[g], (b = f.onload = f.onerror = null),
                           "abort" === a
                               ...
                               : "error" === a
                                     ...
                                     : d(Dc[f.status] || f.status, f.statusText,
                 ...
                 g.length > 0 &&
                     n.ajax({url : a, type : e, dataType : "html", data : b})
                         .done(function(a) {
                           (f = arguments),
                               g.html(
                                   d ? n("<div>").append(n.parseHTML(a)).find(d)
                                     : a);
                         })
                         .complete(c &&
                                   function(a, b) {
