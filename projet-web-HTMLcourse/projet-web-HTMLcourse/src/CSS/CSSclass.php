    ...
    <div class="row  justify-content-between">
        <div class="col-2">
            ...
            <div class="list-group">
                ...
                <a href="CSSclass.php" class="list-group-item list-group-item-action active">les classes</a>
        ...
        <div class="col-8  ">
            ...
            <div class="jumbotron " >
                <h1 class="display-3">les classes</h1>
                <hr class="my-4">

                <h2>La notion de class
                </h2>
            ...
            <div class="container justify-items-end">
                ...
                <a class="boutton" href="CSSLes%20sélecteurs%20descendants.php">
                    <button type="button" class="btn btn-primary"> < Previous </button>
                </a>
                <a class="boutton" href="CSSdivetspan.php">
