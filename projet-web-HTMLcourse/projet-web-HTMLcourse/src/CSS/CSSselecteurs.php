    ...
    <div class="row  justify-content-between">
        <div class="col-2">
            ...
            <div class="list-group">
                ...
                <a href="CSSselecteurs.php" class="list-group-item list-group-item-action active">les selecteurs principaux</a>
        ...
        <div class="col-8  ">
            ...
            <div class="jumbotron " >
                <h1 class="display-3">Les selecteurs</h1>
                <hr class="my-4">
