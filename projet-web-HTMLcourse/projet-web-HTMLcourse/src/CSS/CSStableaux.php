    ...
    <div class="row  justify-content-between">
        <div class="col-2">
            ...
            <div class="list-group">
                ...
                <a href="CSStableaux.php" class="list-group-item list-group-item-action active"> les tableaux</a>
        ...
        <div class="col-8  ">
            ...
            <div class="jumbotron " >
                <h1 class="display-3">Les styles du tableau
                </h1>
                <hr class="my-4">
            ...
            <div class="container justify-items-end">
                ...
                <a class="boutton" href="CSSquiz.php">
