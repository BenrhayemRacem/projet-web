...
<div class="container">
    <div class="progress">
        <div class="progress-bar progress-bar-striped  progress-bar-animated " role="progressbar" style="width: 25%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
    </div>
</div>
    ...
    <div class="row  justify-content-between">
        <div class="col-2">
            <div class="list-group">
                ...
                <a href="HTMLbalises.php" class="list-group-item list-group-item-action active">HTML balises</a>
