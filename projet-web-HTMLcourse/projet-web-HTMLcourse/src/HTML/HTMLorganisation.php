...
<div class="container">
<div class="progress">
    <div class="progress-bar  progress-bar-animated progress-bar-striped " role="progressbar" style="width: 85%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
</div>
</div>
<div class="container ">
<div class="row  justify-content-between">
    <div class="col-2">
        <div class="list-group">
            ...
            <a href="HTMLorganisation.php" class="list-group-item list-group-item-action active ">HTML organisation</a>
...
<div id="page">
    ...
    <div class="main">
        <div class="jumbotron">
            <h1 class="display-3">les balises semantique</h1>
            <hr class="my-4">
            ...
            <p>
                ...
                <img src="../../Assets/images/HTMLorganisation.png" class="img-thumbnail">
        ...
        <div class="container justify-items-end">
            ...
            <a class="boutton" href="HTMLtypesinput.php">
