...
<div class="container">
    <div class="progress">
        <div class="progress-bar  progress-bar-animated progress-bar-striped " role="progressbar" style="width: 81%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
    </div>
</div>
    ...
    <div class="row  justify-content-between">
        <div class="col-2">
            <div class="list-group">
                ...
                <a href="objets.php" class="list-group-item list-group-item-action active">Les objets</a>
        ...
        <div class="col-8">
            <div id="page">
                ...
                <div class="main">
                    <div class="jumbotron">
                        <h1 class="display-3">Les objets </h1>
                        <hr class="my-4">
