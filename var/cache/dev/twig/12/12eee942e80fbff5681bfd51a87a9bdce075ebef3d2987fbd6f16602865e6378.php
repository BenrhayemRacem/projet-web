 ...
 ";
    ...
    public function block_Body($context, array $blocks = [])
    {
        ...
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () {
            throw new RuntimeError('Variable "form" does not exist.', 30, $this->source);
        })()), 'form_start');
        echo "
                        <div class=\"row mb-3\">
                            <h5 class=\"mb-0\"> ";
        ...
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () {
            throw new RuntimeError('Variable "form" does not exist.', 32, $this->source);
        })()), "FirstName", [], "any", false, false, false, 32), 'row');
        echo " </h5>
                        </div>
        ...
        })()), "address", [], "any", false, false, false, 40), 'row');
        echo "   </h5>
                        </div>
        ...
        })()), "Bio", [], "any", false, false, false, 44), 'row');
        echo " </h5>
                        </div>
...
";
    ...
    public function block_greetings($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () {
            throw new RuntimeError('Variable "user" does not exist.', 66, $this->source);
        })()), "FirstName", [], "any", false, false, false, 66), "html", null, true);
        echo " </div> ";
    ...
    {
        return array(  225 => 66,  200 => 50,  191 => 44,  184 => 40,  177 => 36,  170 => 32,  165 => 30,  156 => 23,  146 => 22,  133 => 18,  127 => 15,  121 => 12,  118 => 11,  108 => 10,  96 => 7,  91 => 6,  81 => 5,  62 => 3,  39 => 1,);
    }
...
", "user/EditProfileInfo.html.twig", "D:\\newalkheeeer\\projet-web\\templates\\user\\EditProfileInfo.html.twig");
    }
}
