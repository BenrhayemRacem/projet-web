...
class __TwigTemplate_d6dd1dc685a820505ffd59776aeb70dc4a788ca46c7ccee491124b0f87c8b91b extends Template
{
    ...
    <a href=\"";
        ...
        echo "\" class=\"list-group-item list-group-item-action active \">the days</a>
    <a href=\"";
        // line 8
...
";
    ...
    public function block_NextTitle($context, array $blocks = [])
    {
        ...
        echo " <h2 class=\"NextTitle\">Days of the week </h2> ";
    ...
    public function block_Course($context, array $blocks = [])
    {
        ...
        // line 37
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("anglaisCourse", ["num" => 0]);
        echo "\">< Previous</a></div>
                       <div class=\"col\"><a class=\"btn-grad\" href=\"";
        // line 38
...
{% block Bar %}
    ...
    <a href=\"{{ path('anglaisCourse',{num : 1 }) }}\" class=\"list-group-item list-group-item-action active \">the days</a>
...
{% endblock %}
{% block titleParagraphe %} the days {% endblock %}
{% block NextTitle %} <h2 class=\"NextTitle\">Days of the week </h2> {% endblock %}
       ...
       {% block Course %}
           <div class=\"card\" style=\"margin-top: 20px \">
               <div class=\"card-body\">
                   ...
                   <div class=\"container justify-items-end row\">
                       <div class=\"col\"><a class=\"btn-grad\" href=\"{{ path('anglaisCourse',{num : 0 }) }}\">< Previous</a></div>
                       <div class=\"col\"><a class=\"btn-grad\" href=\"{{ path('Discover')}}\">Home</a></div>
                       <div class=\"col\"><a class=\"btn-grad\" href=\"{{ path('anglaisCourse',{num : 2 }) }}\">Next ></a></div>
                   </div>

               </div>
           </div>
       {% endblock %}
", "Courses/writing/anglais/index1.html.twig", "D:\\projetnewnewnew\\templates\\Courses\\writing\\anglais\\index1.html.twig");
    }
}
