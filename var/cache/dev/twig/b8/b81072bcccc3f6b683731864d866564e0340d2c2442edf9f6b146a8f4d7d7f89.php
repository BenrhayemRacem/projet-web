...
/* Courses/ProgLanguage/JS/index7.html.twig */
class __TwigTemplate_854e1d553ba40022b21e6347274282597c9c88b5e569bf2d8e52916a4bf04b12 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Courses/ProgLanguage/JS/index7.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Courses/ProgLanguage/JS/index7.html.twig"));

        $this->parent = $this->loadTemplate("Courses/Course.html.twig", "Courses/ProgLanguage/JS/index7.html.twig", 1);
...
";
    ...
    public function block_Course($context, array $blocks = [])
    {
        ...
        echo "                        <div class=\"card\" style=\"margin-top: 20px \">
                            <div class=\"card-body\">
                                <p> Un tableau est une suite de valeurs de différents
                                    types
                                </p>
                                <p>Pour initialiser un tableau on a plusieurs méthodes : </p>
                                <ul>
                                    <li> monArray = [val1, val2, ,valN];</li>
                                    <li>monArray = new Array(); </li>
                                </ul>

                                <p>Lire un élément du tableau
                                    Avec l’opérateur []  </p>
                                <p> Un tableau peut être tronqué
                                    en modifiant l’attribut length </p>
                                <p> Ajout et suppression
                                    d’éléments </p>
                                <ul>
                                    <li>push(): ajoute une valeur à la
                                        fin du tableau  </li>
                                    <li>unshift(): ajoute une valeur
                                        au début du tableau </li>
                                    <li>delete: supprime un élément </li>
                                </ul>
    ...
    {
        return "Courses/ProgLanguage/JS/index7.html.twig";
    }
    ...
    {
        return array (  252 => 50,  248 => 49,  244 => 48,  216 => 22,  206 => 21,  188 => 20,  169 => 19,  156 => 16,  152 => 15,  148 => 14,  144 => 13,  140 => 12,  136 => 11,  132 => 10,  128 => 9,  124 => 8,  120 => 7,  116 => 6,  111 => 5,  101 => 4,  82 => 3,  63 => 2,  40 => 1,);
    }
...
{% block Bar %}
    ...
    <a href=\"{{ path('JSCourse',{num : 7 }) }}\" class=\"list-group-item list-group-item-action active\">les tableaux</a>
...
{% endblock %}
{% block titleParagraphe %}Les Tableaux {% endblock %}
                    ...
                    {% block Course %}
                        <div class=\"card\" style=\"margin-top: 20px \">
                            <div class=\"card-body\">
                                ...
                                <div class=\"container justify-items-end row\">
                                    <div class=\"col\"><a class=\"btn-grad\" href=\"{{ path('JSCourse',{num : 6 }) }}\">< Previous</a></div>
                                    <div class=\"col\"><a class=\"btn-grad\" href=\"{{ path('Discover')}}\">Home</a></div>
                                    <div class=\"col\"><a class=\"btn-grad\" href=\"{{ path('JSCourse',{num : 8 }) }}\">Next ></a></div>
                                </div>

                            </div>
                        </div>
                    {% endblock %}", "Courses/ProgLanguage/JS/index7.html.twig", "C:\\Users\\DELL\\OneDrive\\Bureau\\GL2-Sem2\\DeveloppementWeb\\Web Project\\WebProject\\templates\\Courses\\ProgLanguage\\JS\\index7.html.twig");
    }
}
