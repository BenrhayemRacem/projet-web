...
class __TwigTemplate_76030e9635c57ee5ff18655dead73f9275d82a36df1426c96336b38013c7c3d4 extends Template
{
    ...
    <a href=\"";
        ...
        echo "\" class=\"list-group-item list-group-item-action active \">the family</a>
    <a href=\"";
        // line 10
...
";
    ...
    public function block_NextTitle($context, array $blocks = [])
    {
        ...
        echo "<h2 class=\"NextTitle\"> membres of the family </h2>   ";
    ...
    public function block_Course($context, array $blocks = [])
    {
        ...
        echo "                        <div class=\"card\" style=\"margin-top: 20px \">
                            <div class=\"card-body\">
                                ...
                                <img src=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/anglais/family.jpeg"), "html", null, true);
...
{% block Bar %}
    ...
    <a href=\"{{ path('anglaisCourse',{num : 4 }) }}\" class=\"list-group-item list-group-item-action active \">the family</a>
...
{% endblock %}
{% block titleParagraphe %}the family{% endblock %}
{% block NextTitle %}<h2 class=\"NextTitle\"> membres of the family </h2>   {% endblock %}
                    ...
                    {% block Course %}
                        <div class=\"card\" style=\"margin-top: 20px \">
                            <div class=\"card-body\">
                                ...
                                <img src=\"{{ asset('images/anglais/family.jpeg')}}\" class=\"img-thumbnail\" width=\"500px\"/>

                                <div class=\"container justify-items-end row\">
                                    <div class=\"col\"><a class=\"btn-grad\" href=\"{{ path('anglaisCourse',{num : 3 }) }}\">< Previous</a></div>
                                    <div class=\"col\"><a class=\"btn-grad\" href=\"{{ path('Discover')}}\">Home</a></div>
                                    <div class=\"col\"><a class=\"btn-grad\" href=\"{{path('anglaisCourse',{num : 5 }) }}\">Next ></a></div>
                                </div>
...
", "Courses/writing/anglais/index4.html.twig", "D:\\projetnewnewnew\\templates\\Courses\\writing\\anglais\\index4.html.twig");
    }
}
