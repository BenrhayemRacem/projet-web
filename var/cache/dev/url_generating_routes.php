...
return [
    ...
    'forgetPasswd' => [[], ['_controller' => 'App\\Controller\\ForgetPasswdController::index'], [], [['text', '/forget']], [], []],
    ...
    'emailForgetPasswd' => [['mail', 'newPasswd'], ['_controller' => 'App\\Controller\\MailController::envoyerEmail'], [], [['variable', '/', '[^/]++', 'newPasswd', true], ['variable', '/', '[^/]++', 'mail', true], ['text', '/forgetPasswdEmail']], [], []],
    ...
    'AddProject' => [['num', 'ProjectName', 'Field'], ['num' => '0', '_controller' => 'App\\Controller\\ProjectsController::indexAddProject'], ['num' => '\\d+'], [['variable', '/', '[^/]++', 'Field', true], ['variable', '/', '[^/]++', 'ProjectName', true], ['variable', '/', '\\d+', 'num', true], ['text', '/Addproject']], [], []],
    ...
    'Edit_Profile' => [[], ['_controller' => 'App\\Controller\\UserController::indexEditInfo'], [], [['text', '/EditProfile']], [], []],
    'Edit_Passwd' => [[], ['_controller' => 'App\\Controller\\UserController::indexEditPasswd'], [], [['text', '/EditPasswd']], [], []],
    ...
    'RemoteMyProjects' => [['id'], ['_controller' => 'App\\Controller\\UserController::indexRemoveMyProjects'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/RemoveMyProject']], [], []],
