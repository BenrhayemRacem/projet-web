...
return [
    ...
    [ // $staticRoutes
        ...
        '/forget' => [[['_route' => 'forgetPasswd', '_controller' => 'App\\Controller\\ForgetPasswdController::index'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        392 => [[['_route' => 'francaisCourse', 'num' => '0', '_controller' => 'App\\Controller\\CourseController::indexfrancais'], ['num'], null, null, false, true, null]],
        434 => [[['_route' => 'emailForgetPasswd', '_controller' => 'App\\Controller\\MailController::envoyerEmail'], ['mail', 'newPasswd'], null, null, false, true, null]],
        465 => [[['_route' => 'anglaisCourse', 'num' => '0', '_controller' => 'App\\Controller\\CourseController::indexanglais'], ['num'], null, null, false, true, null]],
        491 => [[['_route' => 'AllemandCourse', 'num' => '0', '_controller' => 'App\\Controller\\CourseController::indexAllemand'], ['num'], null, null, false, true, null]],
        520 => [[['_route' => 'EspagnolCourse', 'num' => '0', '_controller' => 'App\\Controller\\CourseController::indexEspagnol'], ['num'], null, null, false, true, null]],
        547 => [[['_route' => 'ItalienCourse', 'num' => '0', '_controller' => 'App\\Controller\\CourseController::indexItalien'], ['num'], null, null, false, true, null]],
        575 => [[['_route' => 'RusseCourse', 'num' => '0', '_controller' => 'App\\Controller\\CourseController::indexRusse'], ['num'], null, null, false, true, null]],
        609 => [[['_route' => 'RemoteMyProjects', '_controller' => 'App\\Controller\\UserController::indexRemoveMyProjects'], ['id'], null, null, false, true, null]],
        632 => [[['_route' => 'RemoteMyCourses', '_controller' => 'App\\Controller\\UserController::indexRemoveMyCourses'], ['id'], null, null, false, true, null]],
        677 => [[['_route' => 'mail', '_controller' => 'App\\Controller\\MailController::index'], ['name', 'mail', 'uniqueId'], null, null, false, true, null]],
        685 => [[['_route' => 'mail.verif', '_controller' => 'App\\Controller\\MailController::verificationEmail'], ['mail', 'uniqueId'], null, null, false, true, null]],
        730 => [[['_route' => 'ProjectView', 'num' => '0', '_controller' => 'App\\Controller\\ProjectsController::index'], ['num', 'ProjectName', 'Field'], null, null, false, true, null]],
        773 => [
